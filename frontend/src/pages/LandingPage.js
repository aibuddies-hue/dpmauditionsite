      ...
      <section data-testid="jury-section" className="section-fade" style={{ padding: "80px 24px", background: "#0c0c0c" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 20 }}>
            {[
              { name: "Ankit Nagpal", role: "PR Expert & Pageant Jury", insta: "rareimprints.ankit.nagpal", bio: "Founder of Bang on Target PR. BR Ambedkar National Award winner. Judged 15+ pageants. Shared panel with Bipasha Basu, Dino Morea & Prince Narula. Launching 'Groom to Bloom' academy.", img: "https://www.storyofsouls.com/wp-content/uploads/2020/05/ankit-featured-1.jpg" },
              { name: "Allie Sharma", role: "Model & Influencer", insta: "alliesharmaofficial", bio: "Fashion model and digital influencer with 10.3K+ followers. Known for style content, brand collaborations and fashion event appearances across India.", img: "https://brand-innovators.com/wp-content/uploads/2024/01/6511e1f8d28fb7a9ce0b7b96_Sharma-Allie.jpg" },
              { name: "Dr. Akanksha", role: "Mrs India Title Holder", insta: "akanksha_mrsindia", bio: "Doctor by profession. Mrs. Elegant 2021 winner & Mrs India 2020 finalist. Organized 'Miss & Mrs Raebareli 2022'. Passionate women empowerment advocate.", img: "https://mrsuttarpradeshqe.com/wp-content/uploads/2025/09/DSC7186-scaled.jpg" },
              { name: "Sapna Chauhan", role: "Fashion Stylist & Model", insta: "sapna.styleframes", bio: "Delhi-based fashion stylist, model & makeup artist. 3+ years as personal stylist consultant. Former IndiGo Airlines flight attendant (6.5 yrs). Originally from Shimla — the rising 'Pahadi Diva'.", img: "https://s.talentrack.in/uploads/portfolio_thumb_image/280x350/585/39/585039_677d93a5ddb1a.jpeg" },
              { name: "Dr. Kanchan Vishwakarma", role: "Wellness Expert", insta: "", bio: "Physician and wellness consultant dedicated to holistic health, inner beauty & confidence building for pageant aspirants.", img: "https://images.unsplash.com/photo-1544264796-acfb69e05b37?w=200" },
              { name: "Shalini Kashyap", role: "Industry Mentor", insta: "", bio: "Seasoned talent development mentor with years of experience grooming contestants for national & international pageants.", img: "https://images.unsplash.com/photo-1600430665436-d4ff685937eb?w=200" },
              { name: "Simran Arora", role: "Talent Scout", insta: "", bio: "Talent acquisition specialist focused on discovering fresh faces for fashion, modelling & the entertainment industry.", img: "https://images.unsplash.com/photo-1732888878731-7e52999af144?w=200" },
