  ...
  return (
    <div style={{ background: "#0c0c0c", minHeight: "100vh" }}>
      ...
      <nav className="glass" style={{ position: "sticky", top: 0, width: "100%", zIndex: 50, padding: "6px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(201,168,76,0.2)" }}>
        <a href="/"><img src={DPM_LOGO} alt="DPM Entertainment" style={{ height: 60, objectFit: "contain", filter: "brightness(1.3)", background: "rgba(201,168,76,0.06)", borderRadius: 8, padding: "4px 8px" }} /></a>
      ...
      <footer style={{ background: "#080808", borderTop: "1px solid rgba(201,168,76,0.1)", padding: "40px 24px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
          <img src={DPM_LOGO} alt="DPM Entertainment" style={{ height: 50, objectFit: "contain", marginBottom: 16, filter: "brightness(1.3)" }} />
