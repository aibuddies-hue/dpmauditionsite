...
async def submit_profile(
    ...
    hip: str = Form(""),
    chest: str = Form(""),
    qa_why_model: str = Form(""),
    qa_strengths: str = Form(""),
    qa_role_model: str = Form(""),
    qa_adventure: str = Form(""),
    qa_if_win: str = Form(""),
    ...
    profile = {
        ...
        "dob": dob, "age": age, "marital_status": marital_status, "category": category,
        "alt_phone": alt_phone,
        "address1": address1, "address2": address2, "city": city, "state": state, "postal_code": postal_code,
        "qualification": qualification, "professional_detail": professional_detail,
        "instagram_url": instagram_url, "facebook_url": facebook_url,
        "height": height, "weight": weight, "hair_color": hair_color, "skin_tone": skin_tone,
        "eye_color": eye_color, "body_shape": body_shape,
        "bust": bust, "waist": waist, "hip": hip, "hips": hips, "chest": chest,
        "qa_why_model": qa_why_model, "qa_strengths": qa_strengths, "qa_role_model": qa_role_model,
        "qa_adventure": qa_adventure, "qa_if_win": qa_if_win,
    ...
    fire_and_forget(N8N_PROFILE, {
        ...
        "dob": dob,
        "age": age,
        "category": category or (app_doc.get("category", "") if app_doc else ""),
        ...
        "hip": hip,
        "chest": chest,
        "qa_why_model": qa_why_model,
        "qa_strengths": qa_strengths,
        "qa_role_model": qa_role_model,
        "qa_adventure": qa_adventure,
        "qa_if_win": qa_if_win,
